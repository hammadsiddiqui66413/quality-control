            ...
            <ul class="navbar-nav align-items-center">
                <li class="nav-item dropdown ms-lg-3">
                    ...
                    <div class="dropdown-menu dashboard-dropdown dropdown-menu-end mt-2 py-1">
                        ...
                        $('#logout-form-client').submit();">
                            <form method="GET" id="logout-form-client" action="{{ route('client.logout') }}">
                                @csrf
                            </form>
                        ...
                        <a class="dropdown-item d-flex align-items-center" href="" onclick="event.preventDefault();
                        $('#logout-form-terminal').submit();">
                            <form method="GET" id="logout-form-terminal" action="{{ route('terminal.logout') }}">
                                @csrf
                            </form>
                            <svg class="dropdown-icon text-danger me-2" fill="none" stroke="currentColor"
                                viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
